...
import ru.mirea.sergeeva.yandexdriver.databinding.ActivityMainBinding;

public class MainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener {
    private ActivityMainBinding binding;
    private Point locate;
    private Point ROUTE_START_LOCATION ;
    private final Point ROUTE_END_LOCATION = new Point( 55.7632314,37.5765979);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isWork) {
            ...
            locationListener = new LocationListener() {
                ...
                public void onLocationUpdated(@NonNull Location location) {
                    if (upd) {
                        locate = location.getPosition();
                        ROUTE_START_LOCATION = new Point(locate.getLatitude(), locate.getLongitude());
        ...
        marker.addTapListener(new MapObjectTapListener() {
            ...
            public boolean onMapObjectTap(@NonNull MapObject mapObject, @NonNull Point point) {
                Toast.makeText(getApplication(),"зоопарк", Toast.LENGTH_SHORT).show();
                return false;
            }
        });
    }
